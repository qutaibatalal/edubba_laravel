        ...
        <div class="side-brand">
            ...
            <div class="brand-content">
                <div class="brand-top">
                    ...
                    <div class="brand-heading"><?php echo app('translator')->get('school_management_system'); ?></div>
                    <div class="brand-desc"><?php echo app('translator')->get('login_hero_desc'); ?></div>

                    <div class="brand-features">
                        <div class="bf">
                            <div class="bf-icon"><i class="bi bi-people-fill"></i></div>
                            <div class="bf-text"><?php echo app('translator')->get('login_feat_students'); ?></div>
                        </div>
                        <div class="bf">
                            <div class="bf-icon"><i class="bi bi-cash-stack"></i></div>
                            <div class="bf-text"><?php echo app('translator')->get('fees_invoices'); ?></div>
                        </div>
                        <div class="bf">
                            <div class="bf-icon"><i class="bi bi-calendar2-week-fill"></i></div>
                            <div class="bf-text"><?php echo app('translator')->get('smart_timetable'); ?></div>
                        </div>
                        <div class="bf">
                            <div class="bf-icon"><i class="bi bi-graph-up-arrow"></i></div>
                            <div class="bf-text"><?php echo app('translator')->get('ministry_reports'); ?></div>
                        </div>
                    </div>
                </div>
                <div class="brand-foot">© <?php echo e(date('Y')); ?> <?php echo e($schoolName); ?></div>
            </div>
        </div>
        ...
        <div class="side-form">
            <div class="form-head">
                <div class="form-head-row">
                    <div>
                        <div class="form-greeting"><?php echo app('translator')->get('welcome_back'); ?></div>
                        <div class="form-sub"><?php echo app('translator')->get('login_subtitle'); ?></div>
                    </div>
                    <div>
                        <button class="lang-trigger" type="button" onclick="toggleLang(event)" title="<?php echo app('translator')->get('language'); ?>">
            ...
            <form method="POST" action="<?php echo e(route('admin.login.post')); ?>" id="loginForm">
                <?php echo csrf_field(); ?>
                <div class="fld">
                    <label class="fld-label"><?php echo app('translator')->get('email'); ?></label>
                    <div class="fld-wrap">
                        <i class="fld-ico bi bi-envelope"></i>
                        <input type="email" name="email" class="fld-input" value="<?php echo e(old('email')); ?>" placeholder="admin@school.com" required autofocus>
                    </div>
                </div>
                <div class="fld">
                    <label class="fld-label"><?php echo app('translator')->get('password'); ?></label>
                    <div class="fld-wrap">
                ...
                <div class="fld-opts">
                    <label class="chk">
                        ...
                        <span class="chk-text"><?php echo app('translator')->get('remember_me'); ?></span>
                    </label>
                    <a href="#" class="forgot"><?php echo app('translator')->get('forgot_password'); ?></a>
                </div>

                <button type="submit" class="btn-go" id="submitBtn">
                    <span class="btn-label"><?php echo app('translator')->get('login'); ?></span>
    ...
    <ul class="lang-popup" id="langPopup">
        <li>
            <a href="<?php echo e(route('language.switch', 'ar')); ?>">
                <span class="lang-active"><?php echo e(app()->getLocale() === 'ar' ? '✓' : ''); ?></span>
                <?php echo app('translator')->get('arabic'); ?>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('language.switch', 'en')); ?>">
                <span class="lang-active"><?php echo e(app()->getLocale() === 'en' ? '✓' : ''); ?></span>
...
<?php /**PATH C:\Users\qutaiba\Desktop\edubba_laravel\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>