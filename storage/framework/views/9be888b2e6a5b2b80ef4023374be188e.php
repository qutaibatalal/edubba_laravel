...
?>
<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>" data-bs-theme="dark">
<head>
    <meta charset="utf-8">
    ...
    <style>
        :root {
            --p: <?php echo e($primaryColor); ?>;
            --p-rgb: <?php echo e($primaryRgb); ?>;
            --edb-sidebar-w: 272px;
    ...
    <div class="nav-footer">
        <div class="user-chip">
            ...
            <span class="u-txt">
                ...
                <span class="d-block" style="font-size:.62rem;color:var(--t3)"><?php echo app('translator')->get('system_admin'); ?></span>
            </span>
        </div>
    </div>
</div>
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" style="width:320px">
                    <div class="px-3 py-2 fw-bold small" style="border-bottom:1px solid rgba(255,255,255,0.06)"><?php echo app('translator')->get('notifications'); ?></div>
            ...
            <div class="dropdown">
                <button class="edb-icon-btn rounded-3 p-0 border-0" style="width:42px;height:42px;background:transparent;border:none !important" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="avatar" style="width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,var(--p),#7c3aed)"><?php echo e(mb_substr(Auth::user()->name, 0, 1)); ?></span>
                </button>
                <div class="dropdown-menu dropdown-menu-end" style="min-width:220px">
                    <div class="px-3 py-2 mb-1" style="border-bottom:1px solid rgba(255,255,255,0.06)">
                        <span class="d-block fw-bold small" style="color:var(--t1)"><?php echo e(Auth::user()->name); ?></span>
...
<?php /**PATH C:\Users\qutaiba\Desktop\edubba_laravel\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>