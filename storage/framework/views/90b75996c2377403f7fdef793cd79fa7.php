...
<head>
    ...
    <title><?php echo app('translator')->get('login'); ?> — <?php echo e($schoolName); ?></title>
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', 'Tajawal', system-ui, sans-serif; }
        ...
        .login-brand {
            position: relative; background: linear-gradient(160deg, <?php echo e($primaryColor); ?>, #6d28d9);
        ...
        .input-group-form input:focus { outline: none; border-color: <?php echo e($primaryColor); ?>; box-shadow: 0 0 0 4px rgba(<?php echo e($primaryRgb); ?>, .1); background: #fff; }
        ...
        .btn-login {
            ...
            box-shadow: 0 12px 28px -8px <?php echo e($primaryColor); ?>; transition: all .25s ease; font-size: .95rem; letter-spacing: -.01em;
        }
        .btn-login:hover { filter: brightness(1.08); transform: translateY(-2px); box-shadow: 0 16px 36px -8px <?php echo e($primaryColor); ?>; }
...
<body>
    ...
    <div class="login-shell">
        <div class="login-brand">
            <img class="login-logo" src="<?php echo e(asset('images/edubba_app.png')); ?>" alt="<?php echo e($schoolName); ?>">
            <div>
                <h2><?php echo app('translator')->get('school_management_system'); ?></h2>
                <p><?php echo app('translator')->get('login_hero_desc'); ?></p>
                <div class="feat"><i class="bi bi-people-fill"></i> <?php echo app('translator')->get('login_feat_students'); ?></div>
                <div class="feat"><i class="bi bi-cash-stack"></i> <?php echo app('translator')->get('fees_invoices'); ?></div>
                <div class="feat"><i class="bi bi-calendar2-week-fill"></i> <?php echo app('translator')->get('smart_timetable'); ?></div>
                <div class="feat"><i class="bi bi-graph-up-arrow"></i> <?php echo app('translator')->get('ministry_reports'); ?></div>
            </div>
            <div style="font-size:.78rem;opacity:.65;font-weight:500">© <?php echo e(date('Y')); ?> <?php echo e($schoolName); ?></div>
        </div>

        <div class="login-form-side">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h1><?php echo app('translator')->get('welcome_back'); ?></h1>
                    <p class="sub mb-4"><?php echo app('translator')->get('login_subtitle'); ?></p>
                </div>
                <div class="dropdown">
                    <button class="btn btn-sm border" type="button" data-bs-toggle="dropdown" title="<?php echo app('translator')->get('language'); ?>" style="border-radius:10px;color:#475569;background:#f8f9fc;border-color:#e2e8f0 !important">
                        <i class="bi bi-globe2"></i>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?php echo e(route('language.switch', 'ar')); ?>"><span class="me-2"><?php echo e(app()->getLocale() === 'ar' ? '✓' : ''); ?></span><?php echo app('translator')->get('arabic'); ?></a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('language.switch', 'en')); ?>"><span class="me-2"><?php echo e(app()->getLocale() === 'en' ? '✓' : ''); ?></span><?php echo app('translator')->get('english'); ?></a></li>
                    </ul>
                </div>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.login.post')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label class="form-label fw-bold small" style="font-size:.82rem;color:#475569"><?php echo app('translator')->get('email'); ?></label>
                    <div class="input-group-form">
                        <i class="ic bi bi-envelope-fill"></i>
                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="admin@school.com" required autofocus>
                    </div>
                </div>
                <div class="mb-4">
                    <label class="form-label fw-bold small" style="font-size:.82rem;color:#475569"><?php echo app('translator')->get('password'); ?></label>
                    <div class="input-group-form">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label small" for="remember" style="font-weight:600;color:#475569"><?php echo app('translator')->get('remember_me'); ?></label>
                    </div>
                    <a href="#" class="small text-decoration-none fw-bold" style="color:<?php echo e($primaryColor); ?>;font-weight:700"><?php echo app('translator')->get('forgot_password'); ?></a>
                </div>
                <button type="submit" class="btn-login mb-3"><i class="bi bi-box-arrow-in-left me-2"></i><?php echo app('translator')->get('login'); ?></button>
            </form>

            <div class="demo-box text-center mt-2">
                <i class="bi bi-info-circle me-1"></i>
                <?php echo app('translator')->get('demo_account'); ?>: <code>admin@edubba.test</code> / <code>password</code>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\qut10\Desktop\edubba_laravel\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>