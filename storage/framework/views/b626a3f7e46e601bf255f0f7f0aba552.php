...
<body>
    <div class="doc-head">
        <div class="school">
            ...
            <div>
                ...
                <p><?php echo app('translator')->get('pdf.faculty.school_tagline'); ?></p>
            </div>
        </div>
        <div class="doc-title">
            <h2><?php echo app('translator')->get('pdf.faculty.title'); ?></h2>
            <span><?php echo app('translator')->get('pdf.faculty.title'); ?></span>
        </div>
    </div>
    ...
    <div class="id-card">
        ...
        <div class="role"><?php echo e($member->department?->name ?? '—'); ?> · <?php echo e($member->specialization ?? ''); ?></div>

        <table>
            <tr><td><?php echo app('translator')->get('pdf.faculty.col_staff_no'); ?></td><td><?php echo e($member->faculty_code); ?></td></tr>
            <tr><td><?php echo app('translator')->get('pdf.faculty.col_gender'); ?></td><td><?php echo e($genderText); ?></td></tr>
            <tr><td><?php echo app('translator')->get('pdf.faculty.col_qualification'); ?></td><td><?php echo e($member->qualification ?? '—'); ?></td></tr>
            <tr><td><?php echo app('translator')->get('pdf.faculty.col_join_date'); ?></td><td><?php echo e($member->join_date?->format('Y/m/d') ?? '—'); ?></td></tr>
            <tr><td><?php echo app('translator')->get('pdf.faculty.col_phone'); ?></td><td><?php echo e($member->mobile ?? $member->phone ?? '—'); ?></td></tr>
        </table>

        <div class="badge"><?php echo app('translator')->get('pdf.faculty.badge'); ?></div>
    </div>

    <div class="footer"><?php echo e($schoolName); ?> © <?php echo e(date('Y')); ?> — <?php echo app('translator')->get('pdf.footer_system'); ?></div>
</body>
</html>
<?php /**PATH C:\Users\qut10\Desktop\edubba_laravel\resources\views/pdf/faculty-card.blade.php ENDPATH**/ ?>