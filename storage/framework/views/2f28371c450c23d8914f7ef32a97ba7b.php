...
<head>
    ...
    <style>
        * { font-family: 'Tajawal', sans-serif; box-sizing: border-box; }
        ...
        .amount-box strong { font-size: 18px; color: <?php echo e($primaryColor); ?>; }
    ...
    <div class="doc-head">
        <div class="school">
            ...
            <div>
                ...
                <p><?php echo app('translator')->get('pdf.receipt.school_tagline'); ?></p>
            </div>
        </div>
        <div class="doc-title">
            <h2><?php echo app('translator')->get('pdf.receipt.title'); ?></h2>
            <span><?php echo app('translator')->get('pdf.receipt.title'); ?></span>
        </div>
    </div>

    <div class="meta-row">
        <div class="meta-col">
            <label><?php echo app('translator')->get('pdf.receipt.receipt_no'); ?></label>
            <strong><?php echo e($receipt->receipt_no); ?></strong>
        </div>
        <div class="meta-col">
            <label><?php echo app('translator')->get('pdf.receipt.invoice_no'); ?></label>
            <strong><?php echo e($receipt->invoice?->number); ?></strong>
        </div>
        <div class="meta-col">
            <label><?php echo app('translator')->get('pdf.receipt.date'); ?></label>
            <strong><?php echo e($receipt->date?->format('Y/m/d')); ?></strong>
        </div>
        <div class="meta-col">
            <label><?php echo app('translator')->get('pdf.receipt.student_no'); ?></label>
            <strong><?php echo e($receipt->invoice?->student?->student_code); ?></strong>
        </div>
    </div>

    <div class="meta" style="margin-top:14px">
        <div>
            <label><?php echo app('translator')->get('pdf.receipt.student_name'); ?></label>
            <strong><?php echo e($receipt->invoice?->student?->full_name); ?></strong>
        </div>
        <div>
            <label><?php echo app('translator')->get('pdf.receipt.parent_name'); ?></label>
            <strong><?php echo e($receipt->invoice?->parent?->name); ?></strong>
        </div>
        <div>
            <label><?php echo app('translator')->get('pdf.receipt.payment_method'); ?></label>
            <strong><?php echo e($receipt->payment?->method); ?></strong>
        </div>
        <div>
            <label><?php echo app('translator')->get('pdf.receipt.payment_ref'); ?></label>
            <strong><?php echo e($receipt->payment?->reference); ?></strong>
        </div>
    </div>

    <div class="amount-box">
        <span><?php echo app('translator')->get('pdf.receipt.amount_paid'); ?></span>
        <strong><?php echo e(number_format($receipt->amount, 0)); ?> <?php echo app('translator')->get('pdf.currency'); ?></strong>
    </div>

    <div class="stamp">
        <div class="line"></div>
        <span><?php echo app('translator')->get('pdf.receipt.cashier_sign'); ?></span>
    </div>

    <div class="footer"><?php echo e($schoolName); ?> © <?php echo e(date('Y')); ?> — <?php echo app('translator')->get('pdf.footer_system'); ?></div>
</body>
</html>
<?php /**PATH C:\Users\qut10\Desktop\edubba_laravel\resources\views/pdf/receipt.blade.php ENDPATH**/ ?>